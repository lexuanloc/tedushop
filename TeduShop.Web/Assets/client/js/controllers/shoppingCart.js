var cart = {
    ...
    registerEvent: function () {
        ...
        // Xóa các sự kiện click bind trước đó đi 'cho sạch', sau đó on lên (áp dụng từ v1.7 up)
        ...
        // Không gọi preventDefault vì sẽ làm hủy cơ chế click của checkbox
        // Check box không được tick khi click
    ...
    // Update thông tin giỏ hàng vào session
    updateAll: function () {
        var cartList = [];
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res.status) {
                    ...
                    $('#lblTotalOrder').text(numeral(cart.getTotalOrder()).format('0,0'));
                    // Tạo trigger để load loại trang giỏ hàng
                    cart.registerEvent();
                }
            }
        })
